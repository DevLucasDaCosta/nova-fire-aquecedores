  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative">
          ...
          <button
            ...
            className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer z-10"
          ...
          {/* Tooltip */}
          <div className={`absolute bottom-full right-0 mb-2 transition-all duration-300 ${isPopupOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      ...
      <div className={`fixed bottom-24 right-6 z-40 transition-all duration-200 ease-in-out transform ${
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 w-80 max-w-sm overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-4 relative">
            ...
            <div className="absolute bottom-0 left-0 right-0">
              <svg viewBox="0 0 1440 20" className="w-full h-2 text-white">
